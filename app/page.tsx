          ...
          {WORK_EXPERIENCE.map((job) => (
            ...
            >
              <Spotlight
                ...
                size={64}
              />
              <div className="relative h-full w-full rounded-[15px] bg-gray-50 p-4 dark:bg-zinc-950">
            ...
            <div key={project.name} className="space-y-2">
              {(project.src) && (
                <div className="relative rounded-2xl bg-zinc-50/40 p-1 ring-1 ring-zinc-200/50 ring-inset dark:bg-zinc-950/40 dark:ring-zinc-800/50">
                  {project.src && <ProjectImage src={project.src} alt={project.name} />}
                </div>
              )}
              <div className="px-1">
                <a
                ...
                >
                  ...
                  >
                    <path
                      d="M3.64645 11.3536C3.45118 11.1583 3.45118 10.8417 3.64645 10.6465L10.2929 4H6C5.72386 4 5.5 3.77614 5.5 3.5C5.5 3.22386 5.72386 3 6 3H11.5C11.6326 3 11.7598 3.05268 11.8536 3.14645C11.9473 3.24022 12 3.36739 12 3.5V9C12 9.27614 11.7761 9.5 11.5 9.5C11.2239 9.5 11 9.27614 11 9V4.70711L4.35355 11.3536C4.15829 11.5488 3.84171 11.5488 3.64645 11.3536Z"
                      fill="currentColor"
                      fillRule="evenodd"
                      clipRule="evenodd"
                    />
